...
# read h5ad data MMultiple_Sclerosis
adata_train = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/MMultiple_Sclerosis_dataset/adata_train.h5ad')
adata_test = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/MMultiple_Sclerosis_dataset/adata_test.h5ad')

epochs = 10
project = 'MMultiple_Sclerosis'
print('training...............')
...
for i in range(epochs):
    model_weight_path = '/home/cxc/code/TOSICA-2layer-2/test/MMultiple_Sclerosis/model-%d.pth' % (i)
    ...
    if i == epochs-1:
        new_adata.write('/home/cxc/code/TOSICA-2layer-2/test/MMultiple_Sclerosis/pre_adata.h5ad')
    else:
