...
# read h5ad data MacParland
adata_train = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/MacParland/MacParland_train.h5ad')
adata_test = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/MacParland/MacParland_test.h5ad')
...
for i in range(epochs):
    model_weight_path = '/home/cxc/code/TOSICA-2layer-2/test/MacParland/model-%d.pth' % (i)
    ...
    if i == epochs-1:
        new_adata.write('/home/cxc/code/TOSICA-2layer-2/test/MacParland/pre_adata.h5ad')
    else:
