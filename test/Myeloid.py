...
# read h5ad data
adata_train = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/Myeloid/mye/reference_adata.h5ad')
adata_test = sc.read_h5ad('/home/cxc/data/scRNA-seq/Experiment/Myeloid/mye/query_adata.h5ad')
...
for i in range(epochs):
    model_weight_path = '/home/cxc/code/TOSICA-2layer-2/test/Myeloid/model-%d.pth' % (i)
    ...
    if i == epochs-1:
        new_adata.write('/home/cxc/code/TOSICA-2layer-2/test/Myeloid/pre_adata.h5ad')
    else:
